...
const Hero = React.forwardRef<HTMLElement, HeroProps>(({
  ...
  return <section ref={ref} className={cn("relative z-0 flex min-h-[80vh] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background", className)} {...props}>
        {gradient && <div className="absolute top-0 isolate z-0 flex w-screen flex-1 items-start justify-center">
            ...
            {/* Main glow */}
            <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-[-30%] rounded-full bg-amber-500/60 opacity-80 blur-3xl" />
        ...
        width: "16rem"
      }} className="absolute top-0 z-30 h-36 -translate-y-[20%] rounded-full bg-amber-500/60 blur-2xl" />
        ...
        width: "30rem"
      }} className="absolute inset-auto z-50 h-0.5 -translate-y-[-10%] bg-amber-500/60" />
      ...
      }} className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-amber-500 via-transparent to-transparent [--conic-position:from_70deg_at_center_top]">
        ...
        backgroundImage: `conic-gradient(var(--conic-position), var(--tw-gradient-stops))`
      }} className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-amber-500 [--conic-position:from_290deg_at_center_top]">
