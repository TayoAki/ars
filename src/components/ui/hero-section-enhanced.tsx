        ...
        <div className="flex flex-col items-center gap-6 text-center sm:gap-12">
          ...
          {badge && (
            <Badge variant="outline" className="animate-appear gap-2">
              <span className="text-amber-300/70">{badge.text}</span>
              <a href={badge.action.href} className="flex items-center gap-1 text-amber-400">
                {badge.action.text}
          ...
          {/* Title */}
          <h1 className="relative z-10 inline-block animate-appear bg-gradient-to-r from-amber-400 to-amber-300/70 bg-clip-text text-4xl font-semibold leading-tight text-transparent drop-shadow-2xl sm:text-6xl sm:leading-tight md:text-7xl md:leading-tight">
            {title}
          </h1>

          {/* Description */}
          <p className="text-md relative z-10 max-w-[550px] animate-appear font-medium text-amber-100/80 opacity-0 delay-100 sm:text-xl">
            {description}
          </p>
